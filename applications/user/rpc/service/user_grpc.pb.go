...
const (
	...
	User_FindByPhone_FullMethodName    = "/service.User/FindByPhone"
	User_FindByUsername_FullMethodName = "/service.User/FindByUsername"
)
...
func (c *userClient) FindByPhone(ctx context.Context, in *FindByPhoneRequest, opts ...grpc.CallOption) (*FindByPhoneResponse, error) {
	out := new(FindByPhoneResponse)
	err := c.cc.Invoke(ctx, User_FindByPhone_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserServer) FindByPhone(context.Context, *FindByPhoneRequest) (*FindByPhoneResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FindByPhone not implemented")
}
...
func _User_FindByPhone_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: User_FindByPhone_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).FindByPhone(ctx, req.(*FindByPhoneRequest))
	}
	return interceptor(ctx, in, info, handler)
}
