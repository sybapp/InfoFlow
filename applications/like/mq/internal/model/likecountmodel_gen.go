...
func (m *defaultLikeCountModel) Insert(ctx context.Context, data *LikeCount) (sql.Result, error) {
	...
	ret, err := m.conn.ExecCtx(ctx, query, data.BizId, data.TargetId, data.LikeNum, data.DislikeNum)
	return ret, err
}
...
func (m *defaultLikeCountModel) Update(ctx context.Context, data *LikeCount) error {
	...
	_, err := m.conn.ExecCtx(ctx, query, data.BizId, data.TargetId, data.LikeNum, data.DislikeNum, data.Id)
	return err
}
